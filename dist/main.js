...
var options = {
  ...
  classes: {
    container: 'onofy-container',
    textbox: 'onofy-textbox',
    textboxInner: 'onofy-textbox-inner',
    button: 'onofy-button',
    element: 'onofy-element',
    elementHalf: 'onofy-element-half',
    elementThird: 'onofy-element-third',
    overlay: 'onofy-overlay',
    backgroundSuccess: 'onofy-background-success',
    backgroundWarning: 'onofy-background-warning',
    backgroundError: 'onofy-background-error',
    backgroundInfo: 'onofy-background-info',
    backgroundNeutral: 'onofy-background-neutral',
    backgroundOverlay: 'onofy-background-overlay',
    alert: 'onofy-alert',
    inputField: 'onofy-input-field',
    selectChoiceRepeated: 'onofy-select-choice-repeated',
    dateSelectorInner: 'onofy-date-selector-inner',
    dateSelectorUp: 'onofy-date-selector-up'
  },
  ids: {
    overlay: 'onofy-overlay'
  },
